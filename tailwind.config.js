  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh':      'radial-gradient(ellipse at 20% 50%, rgba(217,119,6,0.15) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(59,130,246,0.10) 0%, transparent 50%)',
